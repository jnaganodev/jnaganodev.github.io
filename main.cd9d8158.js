! function(e) {
        ...
        h = function(e) {
            ...
            return o(t, e), u(t, [{
                ...
                value: function() {
                    ...
                    var t = "Z2lkOi8vc2hvcGlmeS9Db2xsZWN0aW9uLzIyOTYyNTgyMzM5MA==";
                ...
                value: function(e, t) {
                    ...
                    return this.props.client.checkout.updateLineItems(r, i).then(function(e) {
                        n.setState({
                            checkout: e
                        })
                    })
            ...
            return o(t, e), u(t, [{
                ...
                value: function() {
                    ...
                    return l.default.createElement("div", {
                        ...
                        className: "pricing"
                    }, "$ ", this.props.checkout.subtotalPrice))), l.default.createElement("div", {
                        className: "Cart-info clearfix"
                    }, l.default.createElement("div", {
                        className: "Cart-info__total Cart-info__small"
                        ...
                        className: "pricing"
                    }, "$ ", this.props.checkout.totalTax))), l.default.createElement("div", {
                        className: "Cart-info clearfix"
                    }, l.default.createElement("div", {
                        className: "Cart-info__total Cart-info__small"
                        ...
                        className: "pricing"
                    }, "$ ", this.props.checkout.totalPrice))), l.default.createElement("button", {
        ...
        c = function(e) {
            ...
            return o(t, e), u(t, [{
                ...
                value: function() {
                    ...
                    }, "$ ", (this.props.line_item.quantity * this.props.line_item.variant.price).toFixed(2)), l.default.createElement("button", {
        ...
        m = function(e) {
            ...
            return o(t, e), u(t, [{
                ...
                value: function() {
                    var e = this,
                        t = this.state,
                        n = t.selectedVariantQuantity,
                        r = t.click,
                        i = t.descOpen,
                        a = (this.state.selectedVariantImage || this.props.product.images[0], this.state.selectedVariant || this.props.product.variants[0]),
                        o = this.state.selectedVariantQuantity || 1,
                        u = r ? this.props.product.images[1] : this.props.product.images[0],
                        s = this.props.product.options.map(function(t) {
                            return l.default.createElement(d.default, {
                    ...
                    return l.default.createElement("div", {
                        ...
                        className: "Product" + (a.available ? "" : " sold-out")
                        ...
                        className: "product-desc " + (i ? "product-desc--open" : "")
                    }, l.default.createElement("div", {
                    ...
                    }, this.props.description), l.default.createElement("span", {
                        onClick: function() {
                            return e.setState({
                                descOpen: !i
                            })
                    ...
                    }, "(", i ? "Less" : "More...", ")"), l.default.createElement("div", {
                        className: "product-info__inner"
                    }, s, l.default.createElement("label", {
                        className: "Product__option"
                    }, l.default.createElement("div", {
                        className: "Line-item__quantity-update",
                        onClick: function() {
                            return e.decrementQuantity(n)
                        }
                    }, "-"), l.default.createElement("span", {
                        className: "Line-item__quantity"
                        ...
                        className: "Line-item__quantity-update",
                        onClick: function() {
                            return e.incrementQuantity(n)
                        }
                    }, "+")), l.default.createElement("span", {
                        className: "Product__price"
                    }, "$", a.price), a.available ? l.default.createElement("button", {
                        className: "Product__buy button",
                        onClick: function() {
                            return e.props.addVariantToCart(a.id, o)
                        }
    ...
    var u = function() {
        ...
        f = n(6),
        p = {
            "bliss-fields-t-shirt-black": "Screen + discharge print",
            "peroxide-track-jacket-black": "Screen print back, Embroidery collar + chest",
            "bliss-fields-t-shirt-uk-eu-2020-black": "Screen + discharge print"
        },
        h = function(e) {
            function t() {
                var e, n, r, o;
    ...
    function Gn(e) {
        if (Ms) {
            ...
            if (t) {
                var n = t;
                if (!$n(e, t)) {
                    if (t = We(n.nextSibling), !t || !$n(e, t)) return e.effectTag = e.effectTag & -1025 | 2, Ms = !1, void(Fs = e);
                    Kn(Fs, n)
                }
    ...
    function g(e, t, n, r, i, a) {
        ...
        for (var b in y)
            if ("transform" === b) i.style.transform = y[b];
                ...
                i[w] = y[b]
            } return (void 0 !== s || void 0 !== l || y.transform) && (i.style.transformOrigin = m(t, void 0 !== s ? s : Z, void 0 !== l ? l : Z)), void 0 !== o && (i.x = o), void 0 !== u && (i.y = u), void 0 !== n && void 0 !== d && (i[a ? "stroke-dashoffset" : "strokeDashoffset"] = te(-g, n), i[a ? "stroke-dasharray" : "strokeDasharray"] = te(d, n) + " " + te(p, n)), i
    }
...
//# sourceMappingURL=main.cd9d8158.js.map
